 ...
 * - Agregado el icono de engranaje para representar la receta y arreglado tiempo en card. Integracion de categorias en la card.
    ...
    return (
        ...
        >
            <div
                ...
                id="hero-section"
            >
                <h1 className="text-5xl font-serif font-bold text-black mb-4" data-testid="hero-title" id="hero-title">
                    CookFlow
                </h1>
                <p className="text-lg text-black mb-6" data-testid="hero-subtitle" id="hero-subtitle">
            ...
            <div className="bg-[#e9e6d7] w-full py-16 text-center" data-testid="problem-section" id="problem-section">
                <h2 className="text-2xl font-semibold mb-12" data-testid="problem-title" id="problem-title">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-sm">
                            Despídete del estrés diario de decidir qué comer. Planifica tus comidas de forma fácil,
                            rápida y sin frustraciones
                        </p>
                    </div>
                    <div
                        className="bg-white p-6 rounded-lg shadow-md max-w-sm mx-auto"
                    ...
                    >
                        ...
                        <h3 className="font-semibold text-lg mb-2">No planifiques. Solo cocina.</h3>
                        <p className="text-gray-600 text-sm">
                            Recetas que se pierden, compras a última hora y cenas caóticas. ¿Te suena? Te ayudamos a
            ...
            <div
                ...
                id="solution-section"
            >
                <h2 className="text-2xl font-semibold mb-4" data-testid="solution-title" id="solution-title">
